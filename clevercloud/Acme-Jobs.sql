...
--
-- Table structure for table `corredera_bulletin`
--
...
--
-- Dumping data for table `corredera_bulletin`
--

LOCK TABLES `corredera_bulletin` WRITE;
/*!40000 ALTER TABLE `corredera_bulletin` DISABLE KEYS */;
/*!40000 ALTER TABLE `corredera_bulletin` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `sanjose_bulletin`
--
...
--
-- Dumping data for table `sanjose_bulletin`
--

LOCK TABLES `sanjose_bulletin` WRITE;
/*!40000 ALTER TABLE `sanjose_bulletin` DISABLE KEYS */;
/*!40000 ALTER TABLE `sanjose_bulletin` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `user_account` VALUES (1,0,_binary '\0','john.doe@acme.com','John','Doe','$2a$05$Zezc9mjfIQQCiWnXMfhC5uvfx/ny4AGvj70EJnn7PNveu8GB62mTa','anonymous'),(3,0,_binary '','administrator@acme.com','Administrator','Acme.com','$2a$05$Qtl7CxQ9Cau71QsIDN6RNuG2z4/iZdbgPFm/wWn3Uc7.tgFJ4i.im','administrator');
...
-- Dump completed on 2019-10-23 12:42:02
