...
<acme:form>
	...
	<acme:form-textbox code="administrator.company-record.label.description" path="description"/>
	...
	<acme:form-submit test="${command == 'show'}" code="administrator.company-record.form.buttom.update" action="update"/>
  	<acme:form-submit test="${command == 'show'}" code="administrator.company-record.form.buttom.delete" action="delete"/>
  	...
  	<acme:form-submit test="${command == 'update'}" code="administrator.company-record.form.buttom.update" action="update"/>
  	<acme:form-submit test="${command == 'delete'}" code="administrator.company-record.form.buttom.delete" action="delete"/>
