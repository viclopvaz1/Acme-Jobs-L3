...
<acme:form readonly="true">
	...
	<acme:form-textbox code="authenticated.company-record.label.description" path="descrition"/>
	...
	<acme:form-textbox code="authenticated.company-record.label.indication" path="indication"/>
